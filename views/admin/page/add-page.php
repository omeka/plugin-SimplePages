...
<div id="primary">
    ...
    <form id="simple-pages-form" style="float:left; width: 600px;" method="post">
        ...
        <div class="field">
            <?php echo checkbox(array('name'=>'simple_pages_page_is_published', 'id'=>'simple_pages_page_is_published'), TRUE, null, "Is Published" ); ?>            
        </div>
        <p id="submits"><?php echo submit('Save'); ?></p>
    </form>
</div>
<?php foot(); ?>
