...
class Globals_SimplePagesGetPublicNavigationLinksTest extends SimplePages_Test_AppTestCase
{       
    public function testGetPublicNavigationLinksWithNoLinks()
    {        
       ...
       $navLinks = array();
       $this->assertEquals($navLinks, simple_pages_get_public_navigation_links());
    }
    
    public function testGetPublicNavigationLinksWithOneMainLinks()
    {        
       $this->dispatch('/');
    ...
    public function testGetPublicNavigationLinksWithMultipleMainLinksAndNoSublinks()
    {   
        $testPageCount = 17;
